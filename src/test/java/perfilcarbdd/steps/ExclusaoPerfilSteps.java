...
public class ExclusaoPerfilSteps {
    ...
    @Quando("clicar em excluir {int}")
    public void clicar_em_excluir(Integer id) {
        ...
        this.responseEntity = restTemplate.exchange("http://localhost:8080/perfil/perfil/" + id, HttpMethod.DELETE, request,
                Perfil.class);
    }
